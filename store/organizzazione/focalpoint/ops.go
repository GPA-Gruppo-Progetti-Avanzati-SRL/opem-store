...
func findByDomainAndSiteAndStatus(collection *mongo.Collection, domain string, site string, status string, focalPointBid string, findOptions *options.FindOptions) ([]FocalPoint, error) {
