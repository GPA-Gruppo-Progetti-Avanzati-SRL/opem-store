...
const (
	...
	Address_CountryFieldName       = "address.country"
	Address_Country_BidFieldName   = "address.country.bid"
	Address_County_BidFieldName    = "address.county.bid"
	Address_Townhall_BidFieldName  = "address.townhall.bid"
	Address_Country_TextFieldName  = "address.country.text"
	...
	Address_ZipCodeFieldName       = "address.zip_code"
