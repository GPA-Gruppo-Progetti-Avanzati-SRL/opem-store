...
func FindByPk(collection *mongo.Collection /* pk params, */, mustFind bool, findOptions *options.FindOneOptionsBuilder) (*Magazzino, bool, error) {
	// @tpm-schematics:end-region("find-by-pk-signature-section")
	const semLogContext = "magazzino::find-by-pk"
...
func Find(collection *mongo.Collection, f *Filter, withCount bool, findOptions *options.FindOptionsBuilder) (QueryResult, error) {
	const semLogContext = "magazzino::find"
	fd := f.Build()
...
func FindByFocalPoint(collection *mongo.Collection, domain, site, focalPoint string, findOptions *options.FindOptionsBuilder) (*Magazzino, bool, error) {
