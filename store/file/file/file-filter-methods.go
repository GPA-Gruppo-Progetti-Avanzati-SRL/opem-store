...
// AndTypeEqTo No Remarks
func (ca *Criteria) AndTypeEqTo(p string) *Criteria {
...
// AndTypeIsNullOrUnset No Remarks
func (ca *Criteria) AndTypeIsNullOrUnset() *Criteria {
...
func (ca *Criteria) AndTypeIn(p []string) *Criteria {
...
// @tpm-schematics:start-region("type-field-filter-section")
// @tpm-schematics:end-region("type-field-filter-section")
...
/*
 * filter-string template: in_out
 */

// AndInOutEqTo No Remarks
func (ca *Criteria) AndInOutEqTo(p string) *Criteria {
...
// AndInOutIsNullOrUnset No Remarks
func (ca *Criteria) AndInOutIsNullOrUnset() *Criteria {
...
func (ca *Criteria) AndInOutIn(p []string) *Criteria {
...
// @tpm-schematics:start-region("in-out-field-filter-section")
// @tpm-schematics:end-region("in-out-field-filter-section")
