...
/*
 * filter-string template: cf
 */

// AndCfEqTo No Remarks
func (ca *Criteria) AndCfEqTo(p string) *Criteria {
...
// AndCfIsNullOrUnset No Remarks
func (ca *Criteria) AndCfIsNullOrUnset() *Criteria {
...
func (ca *Criteria) AndCfIn(p []string) *Criteria {
...
// @tpm-schematics:start-region("cf-field-filter-section")
// @tpm-schematics:end-region("cf-field-filter-section")
