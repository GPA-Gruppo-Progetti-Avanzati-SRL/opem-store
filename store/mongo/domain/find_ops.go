...
func FindByPk(collection *mongo.Collection, mustFind bool, findOptions *options.FindOneOptionsBuilder) (*model.Domain, bool, error) {
	const semLogContext = "domain::find-by-pk"
...
func Find(collection *mongo.Collection, f *Filter, withCount bool, findOptions *options.FindOptionsBuilder) (model.DomainQueryResult, error) {
	const semLogContext = "domain::find"
	fd := f.Build()
