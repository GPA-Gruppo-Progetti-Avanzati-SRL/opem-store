...
func (ud *UpdateDocument) Set() *Updates     { return ud.op(Set) }
func (ud *UpdateDocument) Unset() *Updates   { return ud.op(Unset) }
func (ud *UpdateDocument) CurrentDate() *Updates { return ud.op(CurrentDate) }
func (ud *UpdateDocument) Inc() *Updates     { return ud.op(Inc) }
func (ud *UpdateDocument) AddToSet() *Updates { return ud.op(AddToSet) }
func (ud *UpdateDocument) Pull() *Updates    { return ud.op(Pull) }
func (ud *UpdateDocument) Push() *Updates    { return ud.op(Push) }
