...
func FindByPk(collection *mongo.Collection, mustFind bool, findOptions *options.FindOneOptionsBuilder) (*model.Site, bool, error) {
	const semLogContext = "site::find-by-pk"
...
func Find(collection *mongo.Collection, f *Filter, withCount bool, findOptions *options.FindOptionsBuilder) (model.SiteQueryResult, error) {
	const semLogContext = "site::find"
	fd := f.Build()
